...
<div class="flex justify-between lg:w-auto w-full lg:border-b-0 pl-6 pr-2 border-solid border-b-2 border-gray-300 pb-5 lg:pb-0">
    <div class="flex items-center flex-shrink-0 text-gray-800 mr-16">
        <span class="font-semibold text-xl tracking-tight"><a href="/books">Booklist App</a></span>
    </div>
...
<div class="menu w-full lg:block flex-grow lg:flex lg:items-center lg:w-auto lg:px-3 px-8">
    ...
    <div class="relative mx-auto text-gray-600 lg:block hidden">
        ...
        <input
            ...
            type="search" name="search" placeholder="Search for books by title or author">
...
<section class="bg-white">
    <div class="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8 inset-x-0 bottom-0">
        ...
        <p class="mt-8 text-base leading-6 text-center text-gray-400">
            © 2021 Yaraku, Inc. All rights reserved.
        </p>
    </div>
</section>
</body>
