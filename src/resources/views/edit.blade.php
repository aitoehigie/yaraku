...
<div style="width:900px;" class="container pt-4 mx-auto content-center">
    ...
    <div style="width:900px;" class="container max-w-full pt-4 mx-auto">        
        <div class="mb-4">
            ...
            <div class="md:w-2/3">
            <input class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="book-author" name="book-author" type="text" value="{{ $book->author }}">
            </div>
        </div>
